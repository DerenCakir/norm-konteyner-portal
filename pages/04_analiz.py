...
if not site_signal.empty:
    ...
    if "Proseste" in site_signal.columns:
        cols.append("Proseste")
...
st.dataframe(
    ...
    .rename(columns={
        ...
        "boş": "Boş", "wip": "Proseste", "dolu": "Dolu", "kanban": "Kanban",
